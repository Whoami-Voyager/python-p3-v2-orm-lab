...
class Review:
    ...
    def set_year(self, value):
        if isinstance(value, int) and value >= 2000:
            ...
            raise ValueError("Not before the year 2000")
    ...
    def set_summary(self, value):
        if len(value) > 0:
            ...
            raise ValueError("Empty strings are not accepted!")
    ...
    def set_employee(self, value):
        ...
        if type(value) is int and Employee.find_by_id(value):
            ...
            raise ValueError("Not one of my elite employees")
    employee_id = property(get_employee, set_employee)
